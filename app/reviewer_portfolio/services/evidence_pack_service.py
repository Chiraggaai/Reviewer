...
from app.reviewer_portfolio.schemas.evidence_pack_schemas import (
    AcceptanceCriterion,
...
def get_evidence_pack(evidence_id: str, reviewer_user_id: str) -> EvidencePackResponse:
    ...
    from app.reviewer_portfolio.services.rework_coordination_service import get_pack_rework_ui_hints
...
def submit_recommendation(
    ...
    if body.recommendation == RecommendationType.REWORK:
        from app.reviewer_portfolio.services import rework_coordination_service as rcs
