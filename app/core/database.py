...
async def connect_db() -> None:
    ...
    try:
        ...
        # One-line warning: full trace is noisy when Mongo simply is not running locally.
        logger.warning(
            "MongoDB unavailable — API in degraded mode (%s). "
            "Install MongoDB Community for Windows (default port 27017) and start the "
            "MongoDB Server service, or set MONGODB_URL in .env.",
            e,
        )
        client = None
